...
start() {
    ...
    start-stop-daemon --start --quiet --background --make-pidfile --pidfile $PIDFILE --exec #PHPPATH# #DAEMONIZESERVICE# run "#CLASS#" --bootstrap "#BOOTSTRAP#" --rootdir "#ROOTPATH#" #CONSOLEARGS#
    case "$?" in
        0) echo "OK!" ;;
